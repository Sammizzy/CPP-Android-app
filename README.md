...
​
 ## Overview
 This basic app is a proof-of-concept for a high-reliability, **offline-first** inspection system. Designed for field engineers working in remote infrastructure sites, it prioritizes data durability and secure synchronization in environments where network connectivity is intermittent or unavailable.
​
 ## What the App Does
 ...
 *   **Intelligent Synchronization**: The app features a background sync engine built with **Ktor HTTP**. It monitors connectivity and automatically queues data for upload. Once a connection is restored, it pushes the capture history to a central hub using JSON serialization.
...
​
 ...
 The system utilizes a **Hub-and-Spoke** model to bridge mobile and desktop environments:
